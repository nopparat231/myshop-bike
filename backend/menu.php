...
<?php include('mm.php');?> 
<b id="hp">  ADMIN : <?php echo $row_mm['admin_name'];?></b>
<br />  
<ul class="list-group list-group-flush" id="hp">
	...
	if ($row_mm['status'] == 'admin') { ?>
		...
		<il><a href="report_all_prd.php?all=all" class="list-group-item">รายงานข้อมูลสินค้า</a></il>
		<il><a href="report_all_order.php" class="list-group-item">รายงานการสั่งซื้อ</a></il>
		<il><a href="report_best.php" class="list-group-item">รายงานต้นทุนกำไร</a></il>
