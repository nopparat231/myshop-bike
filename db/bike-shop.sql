...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 26, 2018 at 02:05 PM
...
--
ALTER TABLE `tbl_order`
  MODIFY `order_id` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
